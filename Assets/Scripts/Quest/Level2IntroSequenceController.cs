...
public class Level2IntroSequenceController : MonoBehaviour
{
    [Header("References")]
    [SerializeField] private dialogAwalScene openingDialog;
    [SerializeField] private Level2ProgressController progressController;
    ...
    private void ResolveReferences()
    {
        ...
        if (progressController == null)
            progressController =
                FindFirstObjectByType<Level2ProgressController>();
    }
